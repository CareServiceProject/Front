...
import { cancelHelpRequest } from '../../../api/mateApi';
...
const MateMy = () => {
  ...
  const handleMateCancel = (careCid) => {
    cancelHelpRequest(careCid)
      .then((res) => {
        console.log(res);
      })
      .catch((error) => {
  ...
  return (
    <IonPage id="main-menu">
      ...
      <IonContent className="ion-padding">
        ...
        <StatusCard data={data} onCancelHelpRequest={handleMateCancel} />
      </IonContent>
    </IonPage>
  );
};
